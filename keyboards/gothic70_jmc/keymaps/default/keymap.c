...
#define FN1 MO(FN_LAYER)
#define FN2 MO(MEDIA_LAYER)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    FN_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,                    KC_CIRC, \
    SCAPS_LG, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,     FN2,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,             KC_UP,                  \
  ...
  [2] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_MUTE, _______, _______, _______, _______, _______,             KC_MSTP,                \
