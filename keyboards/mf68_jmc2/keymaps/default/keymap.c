...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [NORMAL_LAYER] = LAYOUT_68_ansi(
    ...
    KC_LCTL,  KC_LGUI, KC_LALT,                            KC_SPC,                             FUNC1,    KC_RALT, LAYER2,          KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [FN_LAYER] = LAYOUT_68_ansi(
    ...
    _______,  _______, _______, KC_CALC, _______, _______, _______, KC_MUTE, _______, _______, _______,                   _______,          KC_KGUP,	      
